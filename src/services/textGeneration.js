  ...
  const chat = ai.chats.create({
    ...
    history: [
      ...
      },
      {
        role: "model",
        parts: [{
          text: `You are a helpful and friendly assistant for a 2D video generator tool. Your role is to respond to users after a video is generated based on their prompt.
